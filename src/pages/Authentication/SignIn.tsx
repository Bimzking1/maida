...
const SignIn = () => {
  const value = collection(database, "userCredentials")
  ...
  const handleSubmit = () => {
      if (((username == null) || (username == "")) || ((password == null) || (password == ""))){
        console.log('Please fill the username or password!')
      ...
      } else if ((username === val[0].data.username) && (password === val[0].data.password)){
